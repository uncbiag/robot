...
def plot_trendency(data_list,name_list,x_label="Method", y_label = 'Score',saving_path=None):
...
def compute_std(data_list,name_list):
    for i,name in enumerate(name_list):
        print("the mean and  std  and median of the {}: is {:.3f} , {:.3f} , {:.3f}".format(name, np.mean(data_list[i]), np.std(data_list[i]),np.median(data_list[i])))
...
def get_res_dic():
    data_dic = {}
    data_dic['ICP(affine)'] = get_experiment_data_from_record(inc(),'/playpen-raid1/zyshen/data/lung_expri/opt_icp_60000/records/lmk_diff_mean_records_detail.npy')
    data_dic['RobOT(affine)'] = get_experiment_data_from_record(inc(),'/playpen-raid1/zyshen/data/lung_expri/timing/opt_prealign/records/lmk_diff_mean_records_detail.npy')
    data_dic['CPD(non-param)'] = get_experiment_data_from_record(inc(),'/playpen-raid1/zyshen/data/lung_expri/opt_cpd_20000_beta20_lmd1/records/lmk_diff_mean_records_detail.npy')
    data_dic['RobOT(non-param)'] = get_experiment_data_from_record(inc(),'/playpen-raid1/zyshen/data/lung_expri/timing/opt_gf_60000/records/lmk_diff_mean_records_detail.npy')
    data_dic['RobOTP(spline)'] = get_experiment_data_from_record(inc(),'/playpen-raid1/zyshen/data/lung_expri/timing/opt_discrete_flow_deep/records/lmk_diff_mean_records_detail.npy')
    data_dic['RobOTP(LDDMM)'] = get_experiment_data_from_record(inc(),'/playpen-raid1/zyshen/data/lung_expri/discrete_flow_on_dirlab_deep_lddmm/records/lmk_diff_mean_records_detail.npy')
    data_dic["DGCNN-CPD"] = inc(), np.array([item[1] for item in DGCNN.items()])
    data_dic['DRobOT(disp)'] = get_experiment_data_from_record(inc(),'/playpen-raid1/zyshen/data/lung_expri/timing/deep_flow_prealign_pwc2_2_continue_60000/records/lmk_diff_mean_and_gf_records_detail.npy')
    data_dic['DRobOT(spline)'] = get_experiment_data_from_record(inc(),'/playpen-raid1/zyshen/data/lung_expri/model_eval/deep_flow_prealign_pwc_spline_4096_new_60000_8192_aniso/records/lmk_diff_mean_and_gf_records_detail.npy')
    data_dic['DRobOT(LDDMM)'] = get_experiment_data_from_record(inc(),'/playpen-raid1/zyshen/data/lung_expri/model_eval/draw/deep_flow_prealign_pwc_lddmm_4096_new_60000_8192_aniso_rerun/records/lmk_diff_mean_gf_records_detail.npy')
    data_dic['DRobOT(disp_nn)'] = get_experiment_data_from_record(inc(), '/playpen-raid1/zyshen/data/lung_expri/model_eval/nn/deep_flow_prealign_pwc2_2_continue_60000/records/lmk_diff_mean_gf_records_detail.npy')
    data_dic['DRobOT(spline_nn)'] = get_experiment_data_from_record(inc(), '/playpen-raid1/zyshen/data/lung_expri/model_eval/nn/deep_flow_prealign_pwc_spline_4096_new_60000_8192_aniso_rerun/records/lmk_diff_mean_gf_records_detail.npy')
    data_dic['DRobOT(LDDMM_nn)'] = get_experiment_data_from_record(inc(), '/playpen-raid1/zyshen/data/lung_expri/model_eval/nn/deep_flow_prealign_pwc_lddmm_4096_new_60000_8192_aniso_rerun/records/lmk_diff_mean_gf_records_detail.npy')
    data_dic['DRobOT(disp_robot)'] = get_experiment_data_from_record(inc(),
                                                                  '/playpen-raid1/zyshen/data/lung_expri/model_eval_compare_nn/robot_nonsmooth/deep_flow_prealign_pwc2_2_continue_60000/records/lmk_diff_mean_gf_records_detail.npy')
    data_dic['DRobOT(spline_robot)'] = get_experiment_data_from_record(inc(),
                                                                    '/playpen-raid1/zyshen/data/lung_expri/model_eval_compare_nn/robot_nonsmooth/deep_flow_prealign_pwc_spline_4096_new_60000_8192_aniso_rerun/records/lmk_diff_mean_gf_records_detail.npy')
    data_dic['DRobOT(LDDMM_robot)'] = get_experiment_data_from_record(inc(),
                                                                   '/playpen-raid1/zyshen/data/lung_expri/model_eval_compare_nn/robot_nonsmooth/deep_flow_prealign_pwc_lddmm_4096_new_60000_8192_aniso_rerun/records/lmk_diff_mean_gf_records_detail.npy')

    data_dic['DRobOT(disp_nn_ns)'] = get_experiment_data_from_record(inc(),  '/playpen-raid1/zyshen/data/lung_expri/model_eval/nn_nonsmooth/deep_flow_prealign_pwc2_2_continue_60000/records/lmk_diff_mean_gf_records_detail.npy')
    data_dic['DRobOT(spline_nn_ns)'] = get_experiment_data_from_record(inc(),  '/playpen-raid1/zyshen/data/lung_expri/model_eval/nn_nonsmooth/deep_flow_prealign_pwc_spline_4096_new_60000_8192_aniso_rerun/records/lmk_diff_mean_gf_records_detail.npy')
    data_dic['DRobOT(LDDMM_nn_ns)'] = get_experiment_data_from_record(inc(),  '/playpen-raid1/zyshen/data/lung_expri/model_eval/nn_nonsmooth/deep_flow_prealign_pwc_lddmm_4096_new_60000_8192_aniso_rerun/records/lmk_diff_mean_gf_records_detail.npy')
    return data_dic
...
def draw_single_boxplot(name_list,data_list,label ='Landmark Mean Squared Error',titile=None, fpth=None ,data_name= None,title=None):
