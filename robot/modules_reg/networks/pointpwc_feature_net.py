...
class PointConvFeature(nn.Module):
    def __init__(
        self,
        input_channel=3,
        ...
        super(PointConvFeature, self).__init__()
        ...
        self.cost4 = PointConvFlow(flow_nei, sbf(256 + 64) + 3, sbf([256, 256]))
    ...
    def forward(self, xyz1, color1):
        ...
        return feat1_l1_0.transpose(2, 1).contiguous()
